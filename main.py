...
async def UZB(call:CallbackQuery):
    await call.message.answer("😊😊Xaridingiz uchun raxmat😊😊")
...
Объем оперативной памяти: 6 ГБ
Бренд: Samsung
hozirda narxi:4 452 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 6 ГБ
Бренд: Samsung
hozirda narxi:3 831 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 4 ГБ
Бренд: Samsung
hozirda narxi:2 890 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 4 ГБ
Бренд: Samsung
hozirda narxi:2 690 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 4 ГБ
Бренд: Samsung
hozirda narxi: 2 225 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 8 ГБ
Бренд: Samsung
hozirda narxi:4 859 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 6 ГБ
Бренд: Samsung
hozirda narxi:3 581 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 6 ГБ
Бренд: Samsun
hozirda narxi:2 904 000""",reply_markup = back8 )
    await call.message.delete()
...
Объем оперативной памяти: 2 ГБ
Бренд: Samsung
hozirda narxi:1 903 000""",reply_markup = back8 )
    await call.message.delete()
...
Brend: Xiaomi
hozirda narxi:5 281 000""",reply_markup = back2 )
    await call.message.delete()

@dp.callback_query_handler(text = "m10")
async def UZB(call:CallbackQuery):
    await call.message.answer_photo(
        photo = open('image/mi10pro.jpeg','rb'),
        caption = """Hurmatli mijoz siz tanlagan
xiomi mi 10t pro
...
Brend: Xiaomi
hozirda narxi:6 241 000""",reply_markup = back2 )
    await call.message.delete()
...
Operativ xotira hajmi: 8 ГБ
Brend: Xiaomi
xozirda narxi:4 410 000""",reply_markup = back2 )
    await call.message.delete()

@dp.callback_query_handler(text = "t10")
async def UZB(call:CallbackQuery):
    await call.message.answer_photo(
...
Operativ xotira hajmi: 6 ГБ
Brend: Xiaomi
xozirda narxi:6 200 000""",reply_markup = back2 )
    await call.message.delete()
...
Brend: Xiaomi
xozirda narxi:2 341 000""",reply_markup = back2 )
    await call.message.delete()
...
Operativ xotira hajmi: 6 ГБ
Brend: Xiaomi
xozirda narxi:2 712 000""",reply_markup = back2 )
    await call.message.delete()
...
Operativ xotira hajmi: 6 ГБ
Brend: Xiaomi
xozirda narxi:2 726 000""",reply_markup = back2 )
    await call.message.delete()
...
Operativ xotira hajmi: 4 ГБ
Brend: Xiaomi
xozirda narxi:2 019 000""",reply_markup = back2 )
    await call.message.delete()

@dp.callback_query_handler(text = "9pro")
async def UZB(call:CallbackQuery):
    await call.message.answer_photo(
...
Operativ xotira hajmi: 6 ГБ
Brend: Xiaomi
hozirda narxi:2 763 000""",reply_markup = back2 )
    await call.message.delete()
...
Brend: Xiaomi
hozirda narxi 1 990 000""",reply_markup = back2 )
    await call.message.delete()
...
Brend: Vivo
hozirda narxi:9 061 000""",reply_markup = back3 )
    await call.message.delete()
...
Operativ xotira hajmi: 8 ГБ
Brend: Vivo
hozirda narxi:4 527 000""",reply_markup = back3 )
    await call.message.delete()
...
Operativ xotira hajmi: 8 ГБ
Brend: Vivo
hozirda narxi:4 220 000""",reply_markup = back3 )
    await call.message.delete()
...
Operativ xotira hajmi: 4 ГБ
Brend: Vivo
hozirda narxi:2 100 000""",reply_markup = back3 )
    await call.message.delete()
...
Operativ xotira hajmi: 4 ГБ
Brend: Vivo
hozirda narxi:2 000 000""",reply_markup = back3 )
    await call.message.delete()
...
SIM-kartalar soni: 2
SIM-karta formati: nano SIM
hozirda narxi 1 819 000""",reply_markup = back3 )
    await call.message.delete()
